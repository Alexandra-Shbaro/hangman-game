...
letterElements.forEach(letter => {
    letter.addEventListener('click', () => {
        ...
        // index = selectedWord.indexOf(clickedLetter);
        // console.log(`the index of the letter clicked in the word: "${index}"`); // only for debugging 
        // lines[index].nodeValue = clickedLetter;

    });
});


//checking if the letter is part of the word or not 


//drawLines(); // calling function to draw lines on answer section
